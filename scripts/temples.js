...
const temples = [
...

    {
        ...
        location: "Dallas, Textas, United States",
...
function createTempleCard(filteredTemples) {
    const templeCards = document.getElementById("album-content");
    ...
    filteredTemples.forEach(temple => {
        ...
        table.innerHTML = `
    <tr><th class="titleCard" colspan="2">${temple.templeName}</th></tr>
    <tr><td class="label">LOCATION: </td><td>${temple.location}</td></tr>
    <tr><td class="label">DEDICATED: </td><td>${temple.dedicated}</td></tr>
    <tr><td class="label">SIZE: </td><td>${temple.area} sq ft</td></tr>
  `;
